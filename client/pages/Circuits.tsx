...
const circuits = [
  {
    ...
    description:
      "Experience the magic of the Sahara Desert on this 4-day journey from Marrakech. Cross the Atlas Mountains, visit UNESCO World Heritage sites, and spend a night under the stars in the desert.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Discover Morocco's imperial heritage combined with desert adventure. Visit Fez, Meknes, and experience the magical Sahara Desert with camel trekking and overnight camping.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Immerse yourself in Morocco's royal heritage with visits to all four imperial cities: Casablanca, Rabat, Meknes, and Fez. Discover palaces, mosques, and ancient medinas.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Experience the contrast between Sahara's golden dunes and Atlantic's refreshing breeze. Journey from desert adventures to coastal relaxation in Essaouira.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "The ultimate Morocco experience combining all imperial cities with Sahara Desert adventure. From Casablanca's modernity to ancient Fez and magical desert nights.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Explore southern Morocco's hidden gems from Sahara dunes to Berber villages, historic Taroudant, and coastal Essaouira. The most comprehensive southern adventure.",
    longDescription:
...
export default function Circuits() {
  ...
  const filteredCircuits = circuits.filter((circuit) => {
    const categoryMatch =
      selectedCategory === "All" || circuit.category === selectedCategory;
    const durationMatch =
      selectedDuration === "All" || circuit.duration.includes(selectedDuration);
    const difficultyMatch =
      selectedDifficulty === "All" || circuit.difficulty === selectedDifficulty;
  ...
  const getCategoryIcon = (category: string) => {
    switch (category) {
      ...
      case "Cultural & Desert":
        return <Building2 className="w-5 h-5" />;
      case "Cultural Heritage":
        return <Building2 className="w-5 h-5" />;
      case "Desert & Coast":
        return <Waves className="w-5 h-5" />;
      case "Complete Morocco":
        return <Camera className="w-5 h-5" />;
      case "Authentic Morocco":
              ...
              <div className="relative h-96">
                ...
                <div className="absolute bottom-6 left-6 text-white">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-sm font-semibold ${getDifficultyColor(circuit?.difficulty)}`}
                    >
                      {circuit?.difficulty}
                    </span>
                  </div>
                    ...
                    <div className="bg-gray-50 rounded-xl p-6 sticky top-24">
                      ...
                      <div className="space-y-4 mb-6">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="font-semibold">
                            {circuit?.rating} ({circuit?.reviews} reviews)
                          </span>
                        </div>
                      </div>
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <div className="text-white max-w-2xl">
            ...
            <p className="text-xl mb-8 text-white/90">
              Discover Morocco through our carefully crafted multi-day journeys,
              from imperial cities to Sahara adventures
            </p>
          </div>
        </div>
      </section>
              ...
              >
                <div className="relative h-64 overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4">
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-semibold ${getDifficultyColor(circuit.difficulty)}`}
                    >
                      {circuit.difficulty}
                    </span>
                  </div>
      ...
      <section className="py-20 bg-gradient-to-br from-morocco-brown via-morocco-orange-dark to-morocco-orange text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            Choose your perfect circuit and embark on an unforgettable journey
            through Morocco's diverse landscapes and rich culture
          </p>
