...
const excursions = [
  {
    ...
    description: "Visit the iconic UNESCO World Heritage fortified village, famous as a filming location for Gladiator and Game of Thrones. Cross the Atlas Mountains for an unforgettable day trip.",
  ...
  },
  {
    ...
    description: "Hike through the stunning Imlil Valley at the base of Mount Toubkal. Experience authentic Berber culture, dramatic mountain scenery, and traditional village life.",
  ...
  },
  {
    ...
    description: "Explore the lush Ourika Valley with its seven waterfalls, traditional Berber villages, and argan oil cooperatives. Perfect escape from Marrakech's heat.",
    longDescription: "Escape to the refreshing Ourika Valley, a verdant oasis nestled in the foothills of the High Atlas Mountains, just an hour from Marrakech. This picturesque valley is famous for its seven-tiered Setti Fatma waterfalls, traditional Berber villages, and lush green landscapes that provide a stark contrast to the arid plains around Marrakech. The journey takes you through terraced fields, past traditional adobe villages, and along the rushing Ourika River. Visit authentic Berber homes, learn about traditional mountain life, and witness the ancient art of argan oil production at a women's cooperative. The highlight is a guided hike to the beautiful Setti Fatma waterfalls, where you can enjoy refreshing mountain air and stunning views. This excursion offers the perfect combination of cultural immersion and natural beauty.",
  ...
  },
  {
    ...
    description: "Visit Morocco's most spectacular waterfalls cascading 110 meters into rainbow mists. Encounter playful Barbary monkeys and enjoy boat rides at the base.",
...
const categories = ["All", "Cultural Heritage", "Coastal Culture", "Mountain Adventure", "Nature & Culture", "Natural Wonder"];
...
export default function Excursions() {
  ...
  const filteredExcursions = excursions.filter(excursion => {
    const categoryMatch = selectedCategory === "All" || excursion.category === selectedCategory;
    const durationMatch = selectedDuration === "All" || excursion.duration.includes(selectedDuration);
    const difficultyMatch = selectedDifficulty === "All" || excursion.difficulty === selectedDifficulty;
    return categoryMatch && durationMatch && difficultyMatch;
  });

  const getCategoryIcon = (category: string) => {
    switch (category) {
      case "Cultural Heritage": return <Camera className="w-5 h-5" />;
      case "Coastal Culture": return <Waves className="w-5 h-5" />;
      case "Mountain Adventure": return <Mountain className="w-5 h-5" />;
      case "Nature & Culture": return <TreePine className="w-5 h-5" />;
      case "Natural Wonder": return <Droplets className="w-5 h-5" />;
  ...
  const getDifficultyColor = (difficulty: string) => {
    switch (difficulty) {
      ...
      case "Easy to Moderate": return "text-blue-600 bg-blue-100";
        ...
        <nav className="bg-white/95 backdrop-blur-md shadow-sm border-b border-gray-100 sticky top-0 z-50">
          <div className="container mx-auto px-4 py-4 flex items-center justify-between">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <a href="/circuits" className="text-gray-700 hover:text-morocco-orange transition-all duration-300 font-medium">
                Circuits
              </a>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <div className="relative h-96">
                ...
                <div className="absolute bottom-6 left-6 text-white">
                  <h1 className="text-4xl font-bold mb-2">{excursion?.title}</h1>
                  <div className="flex items-center space-x-4">
                    ...
                    <span className={`px-3 py-1 rounded-full text-sm font-semibold ${getDifficultyColor(excursion?.difficulty)}`}>
              ...
              <div className="p-8">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  <div className="lg:col-span-2">
                    <h2 className="text-2xl font-bold text-gray-800 mb-4">About This Excursion</h2>
                    <p className="text-gray-600 leading-relaxed mb-6">{excursion?.longDescription}</p>
                  ...
                  <div className="lg:col-span-1">
                    <div className="bg-gray-50 rounded-xl p-6 sticky top-24">
                      <div className="text-center mb-6">
                        <div className="text-3xl font-bold text-morocco-orange mb-2">{excursion?.price}</div>
                      ...
                      <div className="space-y-4 mb-6">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="font-semibold">{excursion?.startLocation}</span>
                        </div>
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-2">
                          ...
                          <span className="font-semibold">{excursion?.distance}</span>
                        </div>
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-2">
                          ...
                          <span className="font-semibold">{excursion?.rating} ({excursion?.reviews} reviews)</span>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <button 
                          onClick={() => quickBookingViaWhatsApp(excursion?.title)}
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <div className="text-white max-w-2xl">
            ...
            <p className="text-xl mb-8 text-white/90">
              Discover Morocco's most beautiful destinations on unforgettable day trips from Marrakech
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-6 items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-semibold text-gray-700">Filter Excursions:</span>
            </div>
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4">
                    <span className={`px-3 py-1 rounded-full text-xs font-semibold ${getDifficultyColor(excursion.difficulty)}`}>
                      {excursion.difficulty}
                    </span>
                  </div>
      ...
      <section className="py-20 bg-gradient-to-br from-green-600 via-morocco-orange to-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            Book your favorite day trip and discover the natural beauty and cultural richness of Morocco
          </p>
